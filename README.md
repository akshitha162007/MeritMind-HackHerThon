...
* **Emotion-Blind Evaluation** — Reduces the influence of emotional or subjective signals during screening.
* **Fairness Optimization** — Uses AI-based fairness checks to improve recruitment decisions.
* **Counterfactual Fairness Analysis** — Tests whether changing sensitive attributes affects candidate evaluation.
* **Skill Graph Analysis** — Maps candidate skills and their relationships to job requirements.
* **Job Description Rewriting** — Detects biased language and generates more inclusive job descriptions.
...
```bash
git clone https://github.com/Apoorvacodes376/MeritMind-HackHerThonse.git
cd MeritMind-HackHerThonse
```
